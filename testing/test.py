...
import sys
sys.path.insert(0, '../')
from reservoirpy.nodes import Reservoir, Input, LinearRegression, RidgeRegression, Perceptron, Ridge
...
# clf = Perceptron()
# clf.fit(X_train[:, :, None], y_train[:, None, None])
# preds = clf.run(X_test)
