...
def test_ridge_init():
    ...
    assert node.Wout.shape == (10, 100)
    assert node.bias.shape == (10, 1)
...
def test_ridge_partial_fit():
    ...
    assert node.Wout.shape == (10, 100)
    assert_array_almost_equal(node.Wout, np.ones((10, 100)) * 0.01, decimal=4)
    assert node.bias.shape == (10, 1)
    assert_array_almost_equal(node.bias, np.ones((10, 1)) * 0.01, decimal=4)
...
def test_esn():
    ...
    assert readout.Wout.shape == (10, 100)
    assert readout.bias.shape == (10, 1)
...
def test_hierarchical_esn():
    ...
    assert readout1.Wout.shape == (10, 100)
    assert readout1.bias.shape == (10, 1)

    assert readout2.Wout.shape == (3, 100)
    assert readout2.bias.shape == (3, 1)
