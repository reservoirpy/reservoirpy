# Contributing to ReservoirPy

Before anything else, thank you for taking the time to contribute to this project! :tada::+1:

ReservoirPy is a young project actively developed by a very small team of researchers and engineers,
and we are very happy to welcome new contributors.

The following is a set of guidelines for contributing to ReservoirPy. There are many ways of
contributing, from developing new tools within the project itself to creating new examples and
tutorials, or improving the documentation. 
...
It also helps us if you spread the word: reference the project from your blog and articles, 
